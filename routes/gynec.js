...
const{GynecModel} =require("../model/index");
const { getAllDoctors, getSingleDoctorbyId, AddNewDoctor, UpdateDoctor, DeleteDoctorById} = require("../controller/Gynec-controller");
